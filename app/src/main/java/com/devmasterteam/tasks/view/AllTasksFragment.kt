...
class AllTasksFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, b: Bundle?): View {
        ...
        val listener = object : TaskListener {
            ...
            override fun onDeleteClick(id: Int) { viewModel.delete(id) }

            override fun onCompleteClick(id: Int) { viewModel.status(id,true) }

            override fun onUndoClick(id: Int) { viewModel.status(id, false) }
        }
...
//  Sempre que o Fragment for aberto oque estiver dentro do onResume será atualizado
